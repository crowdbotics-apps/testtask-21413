"""testtask_21413 URL Configuration
...
admin.site.site_header = "TestTask"
admin.site.site_title = "TestTask Admin Portal"
admin.site.index_title = "TestTask Admin"

# swagger
api_info = openapi.Info(
    title="TestTask API",
    default_version="v1",
    description="API documentation for TestTask App",
)
